    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-900 to-blue-300">
              Hello, I&apos;m{" "}
            </span>
            <br></br>
            <TypeAnimation
          ...
          I love learning new technologies and frameworks. And by learning, I mean googling and copying
          </p>
          <div>
            <Link
              href="/#contact"
            ...
            <Link
              ...
              <span className="block  from-blue-900 to-blue-300 hover:bg-slate-800 rounded-full px-5 py-2">
                Download CV
              </span>
            </Link>
          </div>
